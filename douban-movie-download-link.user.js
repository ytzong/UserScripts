...
if (document.domain == 'book.douban.com') {
	...
	downloadContent = '<div><span class="pl">下载链接:</span> <a href="http://dianying.fm/category/key_' + movieTitle + '" target="_balnk">电影FM</a> / <a href="http://btmee.net/search/?q=' + movieTitle + '" target="_balnk">BTmee</a> / <a href="http://www.btexe.com/search?kw=' + movieTitle + '" target="_balnk">BT磁力</a> / <a href="http://www.btbbt.cc/search-index-keyword-' + movieTitle + '.htm" target="_balnk">BTbbT</a> / <a href="https://www.google.com/search?sourceid=chrome&ie=UTF-8&q=' + movieTitle + '+1080p" target="_balnk">Google</a><br><span class="pl">字幕链接:</span> <a href="http://subhd.com/search/' + movieTitle + '" target="_balnk">SubHD</a> / <a href="http://www.zimuzu.tv/search?keyword=' + movieTitle + '" target="_balnk">Zimuzu</a><div>';
}
